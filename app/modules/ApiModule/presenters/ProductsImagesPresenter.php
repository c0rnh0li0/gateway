 ...
 * @author Lukas Bruha
 */
class ProductsImagesPresenter extends BasePresenter {
    ...
    protected function getApiList() {
        ...
        $content .= "GET \t /api/rest/1.0/productsimages \t This help list. \n";
        $content .= "POST \t /api/rest/1.0/productsimages/<connection_name> \t Expects attached Etron XML file with products or standard 
