<?php //netteCache[01]000394a:2:{s:4:"time";s:21:"0.53912200 1390396280";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:72:"/var/www/gateway/app/modules/AdminModule/templates/Default/default.latte";i:2;i:1383647104;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:30:"2f3808e released on 2012-07-30";}}}?><?php

// source file: /var/www/gateway/app/modules/AdminModule/templates/Default/default.latte

?><?php
// prolog Nette\Latte\Macros\CoreMacros
list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, 'desngk4yim')
;
// prolog Nette\Latte\Macros\UIMacros
//
// block pageTitle
//
if (!function_exists($_l->blocks['pageTitle'][] = '_lb7dd85033ed_pageTitle')) { function _lb7dd85033ed_pageTitle($_l, $_args) { extract($_args)
?>    <h2>Overview</h2>
<?php
}}
...
// block textContent
//
if (!function_exists($_l->blocks['textContent'][] = '_lb1dd7d1bef5_textContent')) { function _lb1dd7d1bef5_textContent($_l, $_args) { extract($_args)
?>	<div id="content">
...
// block _ajaxChange
//
if (!function_exists($_l->blocks['_ajaxChange'][] = '_lbee9a5133de__ajaxChange')) { function _lbee9a5133de__ajaxChange($_l, $_args) { extract($_args); $_control->validateControl('ajaxChange')
...
// block sidebar
//
if (!function_exists($_l->blocks['sidebar'][] = '_lb15d5fb90d4_sidebar')) { function _lb15d5fb90d4_sidebar($_l, $_args) { extract($_args)
?>    <div class="box form">
        <h3>Server limits</h3>
