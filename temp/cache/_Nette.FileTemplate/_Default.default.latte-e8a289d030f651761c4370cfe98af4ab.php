<?php //netteCache[01]000394a:2:{s:4:"time";s:21:"0.36660500 1390232881";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:72:"/var/www/gateway/app/modules/AdminModule/templates/Default/default.latte";i:2;i:1383647104;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:30:"2f3808e released on 2012-07-30";}}}?><?php

// source file: /var/www/gateway/app/modules/AdminModule/templates/Default/default.latte

?><?php
// prolog Nette\Latte\Macros\CoreMacros
list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, 'acvk5n1ueb')
;
// prolog Nette\Latte\Macros\UIMacros
//
// block pageTitle
//
if (!function_exists($_l->blocks['pageTitle'][] = '_lb892672f2a6_pageTitle')) { function _lb892672f2a6_pageTitle($_l, $_args) { extract($_args)
?>    <h2>Overview</h2>
<?php
}}
...
// block textContent
//
if (!function_exists($_l->blocks['textContent'][] = '_lba28b45a5e7_textContent')) { function _lba28b45a5e7_textContent($_l, $_args) { extract($_args)
?>	<div id="content">
...
// block _ajaxChange
//
if (!function_exists($_l->blocks['_ajaxChange'][] = '_lb0aa72a0d4a__ajaxChange')) { function _lb0aa72a0d4a__ajaxChange($_l, $_args) { extract($_args); $_control->validateControl('ajaxChange')
...
// block sidebar
//
if (!function_exists($_l->blocks['sidebar'][] = '_lb2ee2e70e0c_sidebar')) { function _lb2ee2e70e0c_sidebar($_l, $_args) { extract($_args)
?>    <div class="box form">
        <h3>Server limits</h3>
